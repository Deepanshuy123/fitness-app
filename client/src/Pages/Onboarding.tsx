import { ArrowLeft, ArrowRight, PersonStanding, Scale, Target, User } from "lucide-react"
...
const Onboarding = () => {
  ...
  const updateField = (field: keyof ProfileFormData, value: number) => {
  ...
  return (
    ...
    <div className="onboarding-container">
      ...
      <div className="p-6 pt-12 onboarding-wrapper">
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-4">Lets give you new eperience</p>
      </div>
      {/* progress */}
      ...
      <div className="flex-1 px-6 onboarding-wrapper">
          ...
          <div className="space-y-6">
            <div className="flex item-center gap-4 mb-8">
              ...
              <div >
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm">This helps us to provide you better solution </p>
              </div>
            </div>
            <Input
              label="Age"
        ...
        {step=== 2 && (
          <div className="space-y-6 onboarding-wrapper">
            <div className="flex item-center gap-4 mb-8">
              <div className="size-12 rounded-xl bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800 flex items-center justify-center"><Scale className="size-6 text-emerald-600 dark:text-emerald-400" /></div>
              <div >
                <h2 className="text-lg font-semibold text-slate-800 dark:text-white">your mesurment </h2>
           ...
           <Input
            ...
            />  <Input
              ...
              onChange={(value) => setFormData({ ...formData, height: value as number })}
            />
         ...
         {step=== 3 && (
          <div className="space-y-6 onboarding-wrapper">
            <div className="flex item-center gap-4 mb-8">
              ...
              <div >
                <h2 className="text-lg font-semibold text-slate-800 dark:text-white">Whats your Goal  </h2>
            ...
            <div className="space-y-4 max-w-lg">
              {goalOptions.map((Option)=>(
                ...
                className={`onboarding-option-btn ${formData.goal===
                  Option.value &&'ring-2 ring-emerald-500'}`}>
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 my-6 max-w-lg"></div>
              <div className="space-y-8 max-w-lg">
                <h3 className="text-md font-medium text-slate-800 dark:text-white mb-4">Daily Target</h3>
              <div className="space-y-6">
                <Slider
